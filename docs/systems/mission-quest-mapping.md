...
> 覆盖范围: cat3 活动任务 2512 条；QuestRange 严格规则 805 条，另有 344 条关卡/物品/竞速安全规则
...
精确关卡、唯一旧映射和官方奖励秒数，并使用历史最佳毫秒值判断。狂热激战 category 24 的 42 条限时任务因旧映射
会把单关扩展为整期 8 个关卡，继续保持持久化 fallback。
