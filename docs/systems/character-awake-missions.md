...
| 2610072 | 杰拉尔作为队长且全场无阵亡 | pattern 95、statistics 17，所有 `zones[].encoffin_count` 总和为 0 |
| 1510062 | 以玛丽安为队长并编入拉芙通关 | 队长 `151006` 与拉芙 `263002` 必须在同一场成功战斗中出现 |
...
- `1510062` 另由显式战斗事实同时校验玛丽安队长与拉芙同场；`1610022/2610072` 另校验全场无阵亡，不能只凭队长累计完成
