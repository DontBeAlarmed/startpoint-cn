...
category `21`；因此旧映射 category `2` / quest `1010004` 不会完成该任务。服务端仅在拉姆斯 `231001`
位于主位 0、成功单人结算且 `elapsed_time_ms <= 90000` 时写入进度。
...
|---------|------|----------|-------------|
| 2310013 | 寄居蟹船长 地狱级 | 1006（category 21） | 90000 (1分30秒) |
