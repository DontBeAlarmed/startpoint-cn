...
- 当前 category 3 共启用 1191 条严格事实：805 条 QuestRange 协力规则和 386 条关卡/物品/竞速规则。
  ...
  其余 1321 条（包括 mission 1807）仍使用持久化 fallback。
...
- category 3 已启用 805 条按 mission ID 的严格协力规则和 386 条关卡/物品/竞速规则；其余 1321 条复杂规则继续补类型化事实，
