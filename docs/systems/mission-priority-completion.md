...
| 称号（category 5） | 1288 | 1039，约 80.7% | 新增单人最高分、单人限时通关、挑战副本累计通关、第二玛纳板、累计体力、累计登录、章节全通、练习关卡 SS、珍品商店购买和指定 Boss 超级难度条件族；unsupported 249 条继续持久化 fallback |
