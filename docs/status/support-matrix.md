...
| 任务系统 | 部分完成：分类存储、独立事实、阶段、普通/每日/每周自动结算、觉醒和 Active Mission 已有；活动、收集、称号与 Pass 6/7/8 缺失 | 普通/每日/每周真实 Fastify/SQLite 路由、事务、回滚、幂等和觉醒回归有覆盖；其他分类缺完整协议矩阵 | 觉醒核心时序已通过；普通、每日、每周及其他分类未完成整体验收 | [任务完成度审计](../systems/mission-completion-audit.md) |
