...
| 管理后台 | React/Vite 是唯一界面且为构建、运行和 Bundle 必需产物；账号备注/清理、设备来源兼容、EX 能力清除和统一写操作反馈已接入，旧路径仅兼容重定向；每日/每周任务强制重置明确不支持 | workspace 构建、路由隔离、入口资源校验、Bundle/verifier、账号清理、设备修改、EX 清除与页面源码契约有覆盖，无完整浏览器交互测试 | 不属于 CN 客户端验收；电脑破坏性操作及手机、平板布局人工验收未完成 | [管理后台](../admin/README.md)、[账号管理与继承码](../systems/account-management-and-takeover.md) |
...
| 任务系统 | 部分完成：普通/每日/每周、收集、1282 条称号、category 3 事实 2485 条、Pass 三分类与等级奖励、觉醒已有；普通分类事实已在登录、上报、故事、战斗、养成、商店和活动入口定向自动结算，Active Mission 保持手动领取；普通任务覆盖已更新为 112/120，`special_total_login_2anv` 已按账号累计登录事实闭合 | 指定 Boss/Advent 累计通关、权威战斗统计、歼灭者 type 86、type 87 HardMulti 条件、魂珠/MVP 等业务操作、QuestRange、948 条已审计空 selector 兼容、活动登录、战阵 summary/SET、角色投票、角色/装备/库存/养成及 Active Mission 核心已有自动测试；普通任务剩余 8 条、category 3 救援 27 条、称号 6 条和 Pass 救援 19 条继续标记为后续实现 | 觉醒核心时序已通过；Type 87 暗机兵完成首轮实机取证；普通分类即时发奖与其余机兵任务仍待统一客户端验收 | [任务完成度审计](../systems/mission-completion-audit.md)、[任务路线图](../systems/mission-roadmap.md)、[Active Mission](../systems/active-mission.md)、[修行之道](../systems/pass-card.md) |
