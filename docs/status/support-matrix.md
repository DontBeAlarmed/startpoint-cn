...
| 任务系统 | 部分完成：普通/每日/每周、收集、23 条称号、觉醒和 Active Mission 已有；活动任务旧 map 已停用自动结算，称号剩余项与 Pass 6/7/8 未完成 | 收集累计、活动隔离、称号首批事实、事务、回滚、幂等和既有分类回归有覆盖；活动类型化事实与其他称号缺完整协议矩阵 | 觉醒核心时序已通过；普通、每日、每周、收集、称号及其他分类未完成整体验收 | [任务完成度审计](../systems/mission-completion-audit.md) |
