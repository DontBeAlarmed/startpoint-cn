...
| 任务系统 | 部分完成：普通/每日/每周、收集、1282 条称号、category 3 事实 2485 条、Pass 三分类与等级奖励、觉醒已有；普通分类事实已在登录、上报、故事、战斗、养成、商店和活动入口定向自动结算，Active Mission 保持手动领取 | 指定 Boss/Advent 累计通关、权威战斗统计、歼灭者 type 86、type 87 HardMulti 条件、魂珠/MVP 等业务操作、QuestRange、948 条已审计空 selector 兼容、活动登录、战阵 summary/SET、角色投票、角色/装备/库存/养成及 Active Mission 核心已有自动测试；称号 6 条已按精确 ID 延期，category 3 其余 27 条救援继续 fallback | 觉醒核心时序已通过；Type 87 暗机兵完成首轮实机取证；普通分类即时发奖与其余机兵任务仍待统一客户端验收 | [任务完成度审计](../systems/mission-completion-audit.md)、[任务路线图](../systems/mission-roadmap.md)、[Active Mission](../systems/active-mission.md)、[修行之道](../systems/pass-card.md) |
