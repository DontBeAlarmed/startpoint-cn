...
| 多人联机 | NPC 建房、招募、TCP、开始与结算可用；start/continue/finish 已校验玩家级 active 身份，房主承担体力和门票；批量玩家快照、独立结算编排与响应投影已接入；超级猫头鹰双场景状态机已实现；可信 host/client Hub、凭据管理、来源代次保护和 Client 新房间有界自动降级/恢复已实现；重赛 NPC 按权威席位核对并同步已 Enter 客户端；房间进程重启恢复仍未实现 | 房间生命周期、清理、身份、入场与结算边界、房主状态、双代 SceneReady、Notify、快照/结算 SQL 上界、故障注入、Hub 三进程、active quest 恢复、本地 fallback，以及约 1000 存档/600 活跃身份的正式混合负载和 runtime descendants 清理均已通过自动门禁 | 基础 NPC 房主流程已有实际使用；多人入场消耗、超级猫头鹰、重赛、昵称显示、TCP 中断和真人跨服流程仍待客户端验收 | [多人联机协议](../protocol/multi-battle.md)、[多人 Hub 设置](../protocol/multi-hub-setup.md)、[可信多人 Hub 架构](../protocol/trusted-multi-hub.md)、[多人优化架构](../systems/multiplayer-hub-optimization.md) |
