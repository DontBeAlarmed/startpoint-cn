...
if (process.argv.length !== 2) {
    throw new Error("fixed mission settlement BASE generator does not accept arguments")
}

process.stdout.write(runGitObjectCollector({
    collectorPath: path.join(__dirname, "mission_settlement_base_collector.cjs"),
