...
test("literal schema 24 migrates to 25 without rewriting existing Gacha state", () => {
    ...
    schema24.exec(`
        ...
        DROP INDEX idx_players_gacha_info_player_gacha;
    ...
    assert.equal(migrated.pragma("user_version", { simple: true }), 25)
