const TEST_GROUPS = Object.freeze({
    ...
    "quick:gacha": {
        ...
        tests: [
            ...
            "tools/gacha_sampled_logging.test.cjs",
    ...
    "quick:quest": {
        ...
        tests: [
            ...
            "tools/quest_recent_other_player_party_route.test.cjs",
    ...
    "quick:character-growth": {
        ...
        tests: [
            ...
            "tools/character_growth_node_transaction.test.cjs",
            "tools/character_growth_exp_commands.test.cjs",
            ...
            "tools/growth_response_projection.test.cjs",
    ...
    "quick:content": {
        ...
        tests: [
            ...
            "tools/box_gacha_content.test.cjs",
            ...
            "tools/quest_daily_content.test.cjs",
            "tools/login_bonus_content.test.cjs",
            "tools/reward_content_catalog.test.cjs",
            "tools/encyclopedia_content.test.cjs",
            "tools/player_rank_content.test.cjs",
            ...
            "tools/event_content_boundary.test.cjs",
            "tools/mission_catalog_startup_boundary.test.cjs",
            "tools/quest_practice_content_boundary.test.cjs",
            "tools/stamina_content_boundary.test.cjs",
            "tools/content_shop_converter.test.cjs",
            "tools/gacha_repository.test.cjs",
            "tools/shop_repository.test.cjs",
            "tools/shop_catalog.test.cjs",
            ...
            "tools/news_html_shell_projection.test.cjs",
            "tools/news_routes.test.cjs",
