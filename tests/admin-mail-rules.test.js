...
assert.strictEqual(getMailAttachmentRule(1, 10001, 321).max, 321)
...
expectOk(validateMailAttachment({ mailType: 1, typeId: 10001, count: 321, itemMaxCount: 321 }))
expectOk(validateMailAttachment({ mailType: 7, typeId: null, count: 100 }))
expectError(validateMailAttachment({ mailType: 1, typeId: 10001, count: 322, itemMaxCount: 321 }), /最多 321/)
expectError(validateMailAttachment({ mailType: 1, typeId: 10001, count: 1 }), /官方持有上限/)
