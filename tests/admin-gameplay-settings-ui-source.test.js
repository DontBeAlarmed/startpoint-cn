...
test("admin exposes validated gameplay settings through the server settings API", () => {
    ...
    assert.match(page, /rush700011To700017CompatibilityEnabled: boolean/)
    assert.match(page, /const saveRushCompatibilitySetting = useMutation/)
    ...
    assert.match(page, /关闭后完全回到官方末期空奖励、空商店行为/)
